...
- **type `"link"`** — vetted links OUT to authoritative public libraries (NSF's official sample, NIH/NIAID funded apps + reviewer critiques, USF/UAF/Northwestern/UChicago/SERC, Open Grants, Candid, Morgan ORA). We **never rehost** these — they're copyrighted and often index pages, not single files.
